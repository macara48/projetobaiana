...
---
A escola de dança Baianá possui o propósito de divulgar o ensino do forró na região e preservar a história dessa dança tradicional. No entanto, observou-se que os processos de avaliação e organização de eventos na escola são realizados manualmente, sem nenhum sistema automatizado, o que dificulta a gestão das informações. Nesse contexto, este projeto foi desenvolvido para solucionar este problema, criou-se um banco de dados estruturado, que reúne registros sobre seus alunos e suas atividades, contribuindo para a preservação da memória da escola e, consequentemente, da identidade cultural nordestina.
---
